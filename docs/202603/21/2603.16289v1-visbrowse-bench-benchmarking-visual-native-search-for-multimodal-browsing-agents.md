...
tldr: "针对现有网页浏览智能体在视觉推理评估不足及忽视原生视觉信息的问题，本文提出了VisBrowse-Bench基准测试。该基准包含169个跨领域的VQA实例，通过文本-图像检索和联合推理验证模型的视觉搜索能力。研究还提出了一种驱动智能体主动收集视觉信息的搜索工作流。实验显示，即使是顶尖模型如Claude-4.6-Opus的准确率也仅为47.6%，揭示了当前多模态智能体在视觉原生搜索方面的巨大挑战。"
selection_source: fresh_fetch
motivation: 现有基准测试缺乏对网页原生视觉信息的关注，且对多模态浏览智能体的视觉推理能力评估不足。
method: 提出了包含169个专家构建实例的VisBrowse-Bench基准，并设计了一套支持主动视觉信息采集与推理的智能体工作流。
result: "实验表明当前最先进的模型（如Claude-4.6-Opus和o3-deep-research）在视觉原生搜索任务上的准确率均低于50%。"
conclusion: VisBrowse-Bench为评估和提升多模态浏览智能体的视觉搜索与推理能力提供了极具挑战性的新标准。
---
