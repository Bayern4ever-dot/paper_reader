...
## 摘要
分析多语种社会的新闻报道可以为公共话语动态和集体叙事的发展提供宝贵见解，然而，考虑到国家媒体生态系统中语言和文化多样性的全面研究仍然有限，特别是在瑞士这样复杂的背景下。本文研究了瑞士数字媒体在法语、德语和意大利语这三个主要语言区域的时间趋势，采用了一种结合定量分析与定性见解的三角互证方法。我们收集并处理了超过170万篇新闻文章，应用了词汇指标、命名实体识别及基于Wikidata的链接、针对性情感分析以及基于共识的变点检测。为了实现有原则的跨语言比较，并与本土化和文化亲近性理论建立联系，我们推导出了本土化概况以及亲近性显著比率。我们的分析涵盖了主题性、周期性及单一事件。通过将定量数据与定性解释相结合，我们为瑞士数字媒体的动态提供了新的见解，并展示了三角互证法在媒体研究中的实用性。研究结果揭示了独特的时间模式，并强调了语言和文化背景如何影响报道。我们的方法提供了一个适用于其他多语种或文化多样化媒体环境的框架，有助于深入理解新闻是如何受语言和文化因素塑造的。
