...
tldr: "针对现有数据集在新闻领域缺乏特定参与者、事件结构和价值导向理解的问题，本文提出了NEVU基准。NEVU包含2,865篇新闻，涵盖从子事件到全文的四个语义层级，通过LLM辅助及人工审核构建，包含54种细粒度价值。该基准旨在评估模型识别特定参与者在特定事件中价值倾向的能力，实验证明轻量化微调能显著提升模型表现。"
selection_source: fresh_fetch
motivation: 现有价值理解数据集往往脱离语境或忽略参与者身份，无法满足真实新闻场景中对特定人物在复杂事件中价值取向的分析需求。
method: 构建了一个包含四个语义粒度的多层级基准，采用LLM辅助生成、多阶段验证及人工审计的流程，标注了大量“单元-参与者”对及其价值导向。
result: 通过对多种大模型的测试发现，轻量化微调（LoRA）能显著提升开源模型在多粒度价值识别任务中的表现。
conclusion: NEVU填补了新闻领域事件驱动价值理解的空白，为评估和提升模型在复杂语境下的社会价值理解能力提供了重要资源。
---
